...
class PredictionThread(threading.Thread):
    ...
    def time_until_n_hours(hours):   # TODO: Put in TimeUtils ASAP
        ...
        predict_time = now + timedelta(hours=0, minutes=0, seconds=hours, microseconds=0) #TODO: change to hours DEBUG
    ...
    def run(self):
        ...
        while not self.stop_event.is_set():
            ...
            try:
                ...
                threading.Timer(10, self.currentPlot.check_threads(self.currentPlot)).start()  # Check every hour if threads are alive
